...
class TestSamtoolExec(unittest.TestCase):
    ...
    def test_samtools_index_with_overide(
        self, env_mock, path_mock, run_mock, version_mock, stdout_mock
    ):
    ...
    @patch("slurm_srst2.os.path")
    @patch("slurm_srst2.os.environ")
    def test_samtools_index_with_default(
        self, env_mock, path_mock, run_mock, version_mock, stdout_mock
    ):
        path_mock.exists.return_value = False
    ...
    @patch("slurm_srst2.os.path")
    @patch("slurm_srst2.os.environ")
    def test_samtools_index_with_missing_overide(
        self, env_mock, path_mock, run_mock, version_mock, stdout_mock
    ):
        path_mock.exists.return_value = False
        path_mock.isfile.side_effect = lambda f: "missing" not in f
...
class TestBowtieIndex(unittest.TestCase):
    ...
    def test_bowtie_index_with_overides(
        ...
        self.assertEqual(version_mock.call_count, 1)
        self.assertEqual(
            version_mock.call_args[0][0], ["/usr/bin/bowtie2", "--version"]
        )
        self.assertEqual(run_mock.call_count, 1)
    ...
    @patch("slurm_srst2.os.path")
    @patch("slurm_srst2.os.environ")
    def test_bowtie_index_with_partial_overide(
        self, env_mock, path_mock, run_mock, version_mock, stdout_mock
    ):
        path_mock.exists.return_value = False
        path_mock.isfile.side_effect = lambda f: "missing" not in f
    ...
    @patch("slurm_srst2.os.path")
    @patch("slurm_srst2.os.environ")
    def test_bowtie_index_with_other_overide(
        self, env_mock, path_mock, run_mock, version_mock, stdout_mock
    ):
        path_mock.exists.return_value = False
        path_mock.isfile.side_effect = lambda f: "missing" not in f
        ...
        slurm_srst2.bowtie_index(["foo"])
        self.assertEqual(version_mock.call_count, 1)
        self.assertEqual(version_mock.call_args[0][0], ["bowtie2", "--version"])
        self.assertEqual(run_mock.call_count, 1)
        run_mock.assert_called_once_with(["/usr/bin/bowtie2-build", "foo", "foo"])
    ...
    @patch("slurm_srst2.os.path")
    @patch("slurm_srst2.os.environ")
    def test_bowtie_index_with_default(
        self, env_mock, path_mock, run_mock, version_mock, stdout_mock
    ):
        path_mock.exists.return_value = False
        env_mock.get.return_value = None
    ...
    @patch("slurm_srst2.os.path")
    @patch("slurm_srst2.os.environ")
    def test_bowtie_index_with_missing_overide(
        self, env_mock, path_mock, run_mock, version_mock, stdout_mock
    ):
        path_mock.exists.return_value = False
        path_mock.isfile.side_effect = lambda f: "missing" not in f
    ...
    @patch("slurm_srst2.os.path")
    @patch("slurm_srst2.os.environ")
    def test_bowtie_index_with_one_missing_overide(
        self, env_mock, path_mock, run_mock, version_mock, stdout_mock
    ):
        path_mock.exists.return_value = False
        path_mock.isfile.side_effect = lambda f: "missing" not in f
    ...
    @patch("slurm_srst2.os.path")
    @patch("slurm_srst2.os.environ")
    def test_bowtie_index_with_other_missing_overide(
        self, env_mock, path_mock, run_mock, version_mock, stdout_mock
    ):
        path_mock.exists.return_value = False
        path_mock.isfile.side_effect = lambda f: "missing" not in f
    ...
    @patch("slurm_srst2.os.path")
    @patch("slurm_srst2.os.environ")
    def test_bowtie_index_with_missing_inference(
        self, env_mock, path_mock, run_mock, version_mock, stdout_mock
    ):
        path_mock.exists.return_value = False
