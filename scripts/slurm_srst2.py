...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,
        help="wall time (default 0-1:0 = 1 h)",
        default="0-1:0",
    )
    parser.add_argument(
        "--memory",
    ...
    # SRST2 inputs
    parser.add_argument("--script", type=str, required=True, help="path to srst2.py")
    parser.add_argument(
        "--output",
        type=str,
        required=True,
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="string containing all other arguments to pass to srst2",
    )
